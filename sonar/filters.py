...
plt.hist(all_noises_tv_cham, bins=200, alpha=0.5, label='tv_chambolle (noisy/denoised)', color='blue', range=(0, 10))
...
plt.figure(figsize=(8, 6))
plt.hist(all_emp, bins=200, alpha=0.5, label='emp (noisy/original)', color='gray', range=(0, 10))
plt.hist(all_noises_bi, bins=200, alpha=0.5, label='bilateral (noisy/denoised)', color='blue', range=(0, 10))
...
plt.figure(figsize=(8, 6))
plt.hist(all_emp, bins=200, alpha=0.5, label='emp (noisy/original)', color='gray', range=(0, 10))
plt.hist(all_noises_wave, bins=200, alpha=0.5, label='wavelet (noisy/denoised)', color='blue', range=(0, 10))
...
plt.figure(figsize=(8, 6))
plt.hist(all_emp, bins=200, alpha=0.5, label='emp (noisy/original)', color='gray', range=(0, 10))
plt.hist(all_unsharp, bins=200, alpha=0.5, label='unsharp (noisy/denoised)', color='blue', range=(0, 10))
...
plt.figure(figsize=(8, 6))
plt.hist(all_emp, bins=200, alpha=0.5, label='emp (noisy/original)', color='gray', range=(0, 10))
plt.hist(all_noises_nl, bins=200, alpha=0.5, label='NL Means (noisy/denoised)', color='blue', range=(0, 10))
...
plt.figure(figsize=(8, 6))
plt.hist(all_emp, bins=200, alpha=0.5, label='emp (noisy/original)', color='gray', range=(0, 10))
plt.hist(all_noises_tv_breg, bins=200, alpha=0.5, label='Bregman (noisy/denoised)', color='blue', range=(0, 10))
