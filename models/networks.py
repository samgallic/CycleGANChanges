...
class NoiseGenerator(nn.Module):
    def __init__(self):
        ...
        model = [
            ...
            nn.Conv2d(64, 128, kernel_size=5, stride=1, padding=3, bias=False),
            nn.ReLU(inplace=True),
            nn.Conv2d(128, 256, kernel_size=7, stride=1, padding=3, bias=False),
            nn.BatchNorm2d(256),
            nn.ReLU(inplace=True),
            nn.ConvTranspose2d(256, 128, kernel_size=7, stride=1, padding=3, bias=False),
            nn.ReLU(inplace=True),
            nn.ConvTranspose2d(128, 64, kernel_size=5, stride=1, padding=3, bias=False),
            nn.ReLU(inplace=True),
